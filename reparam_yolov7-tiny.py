...
argparse.add_argument('--weights', type=str, required=False, default='weights/best.pt', help='The weights to be reparameterized')
argparse.add_argument('--custom_yaml', type=str, required=False, default='cfg/deploy/yolov7-tiny-deploy.yaml', help='custom yaml with deploy parameters')
argparse.add_argument('--output', type=str, required=False, default='weights/best_deploy.pt', help='The target path to save reparameterized weights')
...
model = Model(args.custom_yaml, ch=3, nc=76).to(device)
